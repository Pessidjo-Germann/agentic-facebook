...
class ContentItem(BaseModel):
    post_type: str = Field(description="Catchy title for the content")
    topic_suggestion: str = Field(description="Brief description of the content")
    suggested_time_slot: str = Field(description="Distribute posts logically throughout the day")
...
class DaySchedule(BaseModel):
    ...
    posts: List[ContentItem] = Field(description="List of content to be published on this day")
    model_config = ConfigDict(extra='forbid')
